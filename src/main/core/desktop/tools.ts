        ...
        input_schema: {
            ...
            properties: {
                action: {
                    type: 'string',
                    description:
                        'Action to perform. Primitives: click|type|key|right_click|double_click|scroll|focus|find_window|list_windows|screenshot|screenshot_region|maximize_window|fullscreen_window|verify_window_title|verify_file_exists|wait. Macros: app_launch|open_menu_path|fill_dialog|click_and_type|export_file|validate_menu_bar. Accessibility: a11y_get_tree|a11y_find|a11y_do_action|a11y_set_value|a11y_list_apps. Special: batch_actions|dbus_control|gui_query.',
                },
                window: { type: 'string', description: 'Window title (partial match). Required for click/type/key/focus/macros. Not needed for list_windows or screenshot (full screen).' },
